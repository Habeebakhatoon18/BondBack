...
google.addEventListener('click', function() {
    google.focus();
    window.location.href = "https://about.google/brand-resource-center/guidance/sponsorships/";
});
amazon.addEventListener('click', function() {
    amazon.focus();
    window.location.href ="https://aws.amazon.com/partners/marketing/sponsorships/" ;
});
uber.addEventListener('click', function() {
    uber.focus();
    window.location.href ="https://flows.beamery.com/uber/apac-uber-she---2025-s_29svpsn" ;
});
